...
namespace ChatServer
{
    static class ABKezelo
    {
        ...
        public static List<Users> Olvasas()
        {
            try
            {
                ...
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        users.Add(new Users((DateTime)reader["Idopont"], reader["Uid"].ToString(), reader["Username"].ToString(), reader["Uzenet"].ToString()));
                        //users.Add(new Users(reader["Username"].ToString()));
                    }
                    reader.Close();
                }
